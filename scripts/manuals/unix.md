...
- To find the files that have been changed (with the files data modification time older than) in the
last N days.
...
- Copy directory with tar to different location

```bash
tar -czf /path/to/location/file.tgz directory/
```
